...
public class BubbleBoxBlockEntity extends RandomizableContainerBlockEntity {
    ...
    private final ContainerOpenersCounter openersCounter = new ContainerOpenersCounter(){
        ...
        protected void onOpen(Level level, BlockPos blockPos, BlockState blockState) {
            BubbleBoxBlockEntity.this.playSound(SoundEvents.BARREL_OPEN);
            BubbleBoxBlockEntity.this.updateBlockState(blockState, true);
        }

        @Override
        protected void onClose(Level level, BlockPos blockPos, BlockState blockState) {
            BubbleBoxBlockEntity.this.playSound(SoundEvents.BARREL_CLOSE);
            BubbleBoxBlockEntity.this.updateBlockState(blockState, false);
        }
        ...
        protected boolean isOwnContainer(Player player) {
            if (player.containerMenu instanceof BubbleBoxMenu) {
                Container container = ((BubbleBoxMenu)player.containerMenu).container;
                return container == BubbleBoxBlockEntity.this;
            }
            return false;
        }
    };

    public BubbleBoxBlockEntity(BlockPos blockPos, BlockState blockState) {
        super(IttyBittyBlockEntityType.BUBBLEBOX, blockPos, blockState);
    }

    @Override
    protected Component getDefaultName() {
        return Component.translatable("itty_bitty.container.bubblebox");
    }
    ...
    protected AbstractContainerMenu createMenu(int i, Inventory inventory) {
        return new BubbleBoxMenu(i, inventory, this);
    }
